...
Most of these come down to network reality or how xiaoyuzhou-cli serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

xiaoyuzhou-cli rate-limits like any public site. xiaoyuzhou already paces
...
Where a surface is gated, xiaoyuzhou reads a cookie or token you supply
...
`xiaoyuzhou`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what xiaoyuzhou actually did
